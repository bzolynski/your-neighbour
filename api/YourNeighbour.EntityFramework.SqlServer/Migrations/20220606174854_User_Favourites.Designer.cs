...
namespace YourNeighbour.EntityFramework.SqlServer.Migrations
{
    ...
    [Migration("20220606174854_User_Favourites")]
    partial class User_Favourites
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YourNeighbour.Domain.Entities.FavoriteAdvertisements", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YourNeighbour.Domain.Entities.FavoriteAdvertisements", b =>
                {
                    b.HasOne("YourNeighbour.Domain.Entities.Advertisement", "Advertisement")
                        .WithOne()
                        .HasForeignKey("YourNeighbour.Domain.Entities.FavoriteAdvertisements", "AdvertisementId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YourNeighbour.Domain.Entities.Identity.User", "User")
                        .WithOne()
                        .HasForeignKey("YourNeighbour.Domain.Entities.FavoriteAdvertisements", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
